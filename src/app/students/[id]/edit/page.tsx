...
// Mesmo esquema de validação da página de criação
...
export default function EditStudentPage() {
    ...
    const loadStudent = async () => {
      ...
      try {
        ...
        reset({
          ...
          social_name: mockStudent.social_name || undefined,
          birth_date: mockStudent.birth_date,
          gender: mockStudent.gender as any,
          cpf: mockStudent.cpf || undefined,
          rg: mockStudent.rg || undefined,
          mother_name: mockStudent.mother_name,
          father_name: mockStudent.father_name || undefined,
          guardian_name: mockStudent.guardian_name || undefined,
          guardian_phone: mockStudent.guardian_phone || undefined,
          guardian_email: mockStudent.guardian_email || undefined,
          address_street: mockStudent.address_street || undefined,
          address_number: mockStudent.address_number || undefined,
          address_neighborhood: mockStudent.address_neighborhood || undefined,
          address_city: mockStudent.address_city || undefined,
          address_state: mockStudent.address_state || undefined,
          address_zipcode: mockStudent.address_zipcode || undefined,
          special_needs: mockStudent.special_needs,
          special_needs_description: mockStudent.special_needs_description || undefined,
          school_id: mockStudent.school_id,
          class_id: mockStudent.class_id || undefined,
          registration_number: mockStudent.registration_number,
          status: mockStudent.status as any,
          notes: mockStudent.notes || undefined,
        })

        // Definir o preview da foto se existir
        if (mockStudent.photo_url) {
          setPhotoPreview(mockStudent.photo_url)
        }
      } catch (error) {
  ...
  const onSubmit = async (data: StudentFormValues) => {
    ...
    try {
      ...
      console.log("Nova foto:", photoFile)
      ...
      toast({
        ...
        description: "Ocorreu um erro ao atualizar o aluno. Tente novamente.",
        variant: "destructive",
      })
    } finally {
